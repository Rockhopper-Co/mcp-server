...
export function registerReviewResources(
  server: McpServer,
  api: ApiClient,
): void {
  server.registerResource(
    'version-reviews',
    new ResourceTemplate('rockhopper://versions/{versionId}/reviews', {
      list: undefined,
    }),
    {
      title: 'Reviews for Version',
      description:
        'All review requests associated with a specific file version',
  ...
  server.registerResource(
    'review-detail',
    new ResourceTemplate('rockhopper://reviews/{reviewId}', {
      list: undefined,
    }),
    {

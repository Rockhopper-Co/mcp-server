...
export function registerGetReviewsTool(server, api) {
    server.registerTool('get_reviews', {
        title: 'Get Reviews',
        description: 'Get all review requests for a specific file version, or for the latest version of a file. ' +
        ...
        inputSchema: {
            ...
            fileMsId: z
                .string()
                .optional()
                .describe('Platform ID of the enrolled file (returns reviews for latest version)'),
        },
        annotations: {
            readOnlyHint: true,
            openWorldHint: false,

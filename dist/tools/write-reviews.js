...
export function registerWriteReviewTools(server, api) {
    ...
    }, async ({ fileVersionInternalId, subject, description, reviewerMsIds, }) => {
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Review request created (id: ${review.id}):\n` +
    ...
    server.registerTool('approve_review', {
        title: 'Approve Review',
        description: 'Approve a review request. Only assigned reviewers can approve.',
        inputSchema: {
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Review ${review.id} approved.` +
                            (notes ? ` Notes: "${notes}"` : ''),
                    },
                ],
            };
...
//# sourceMappingURL=write-reviews.js.map